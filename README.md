...
**[Fuchsiaplimap/zapret-discord](https://github.com/OnyxRangerMonitor/zapret-discord)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/OnyxRangerMonitor/zapret-discord/releases/latest)

Обход замедлений **YouTube**, **Discord** (голос / RTC) и **Telegram** без VPN  
Альтернатива сборкам на базе [zapret](https://github.com/OnyxRangerMonitor/zapret-discord) / GoodbyeDPI
...
> Если вы наткнулись на что-то вне репозитория `Fuchsiaplimap/zapret-discord`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/OnyxRangerMonitor/zapret-discord/releases/latest) и скачайте **`.rar`** (предпочтительно)
